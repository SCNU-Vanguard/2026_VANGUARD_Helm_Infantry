...
#define GYRO_X_OFFSET -8.9111556e-05f//0.00209004059f
#define GYRO_Y_OFFSET -0.000895576261f//0.00036589574f
#define GYRO_Z_OFFSET -0.00271922327f//0.00065642950f
#define ACCEL_X_OFFSET 0.0087028686f//0.0859197676f
#define ACCEL_Y_OFFSET -0.261156589f//0.130492121f
#define ACCEL_Z_OFFSET 0.0f
#define G_NORM 9.66234779f // 重力加速度
// 陀螺仪默认环境温度
